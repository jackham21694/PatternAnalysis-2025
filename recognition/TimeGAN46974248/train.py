...
def autoencoder_pretrain(hidden_dim, num_layers, num_features, lr_schedule, training_iterations, X_train, seq_len, batch_size):
...
def supervisor_pretrain(training_iterations, X_train, seq_len, batch_size, autoencoder, supervisor, generator, supervisor_optimiser, generator_optimiser):
  """
  ...
  return autoencoder, supervisor, generator


def joint_training_loop(training_iterations, X_train, seq_len, batch_size, hidden_dim, 
...
# Mount google drive so we can save files
drive.mount('/content/drive')

# Change this path to where your data is located inside your google drive
...
# Pretrain our supervisor and generator
autoencoder, supervisor, generator = supervisor_pretrain(training_iterations, X_train, seq_len, batch_size, 
                                                         autoencoder, supervisor, generator,  
                                                         supervisor_optimiser, generator_optimiser)


# Joint-Training Loop

autoencoder, supervisor, generator, discriminator = joint_training_loop(training_iterations, X_train, seq_len, batch_size, hidden_dim, 
                                                                          autoencoder, supervisor, generator, discriminator, 
                                                                          supervisor_optimiser, generator_optimiser, autoencoder_optimiser, 
                                                                          discriminator_optimiser)